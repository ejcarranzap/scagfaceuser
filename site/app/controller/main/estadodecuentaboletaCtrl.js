(function () {
	...
	app.controller('estadodecuentaboletaCtrl', function ($scope, $log, $filter, boService, $uibModal,
  userService) {
		$scope.data = [];
		$scope.record = {};
      ...
      console.log($scope.alumnos);
		...
		$scope.open = function (record, size, actn) {
			var modalInstance = $uibModal.open({
				...
				templateUrl: 'app/view/main/estadodecuentaboletadet.html?' + (new Date()).getTime(),
				controller: 'estadodecuentaboletadetCtrl',
				size: size,
		...
		$log.info('estadodecuentaboletaCtrl');
	});

	app.controller('estadodecuentaboletadetCtrl', function ($scope, $log, $filter, $window, boService, fileServicePHP, $uibModalInstance,
		record) {
		$scope.record = record;
		...
		$log.info('estadodecuentaboletadetCtrl');
	});
}());
