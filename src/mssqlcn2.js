module.exports.mssqlcn2 = {
	...
	query: function (isMiddleware, request, reply, sqlquery, params, fn, order, extraparam, orderb, extraparamb) {
		try {
			...
			var cn = new module.exports.mssqlcn2.mysql.Connection(module.exports.mssqlcn.config.MSSQL_CONFIG2);
			cn.connect().then(function () {
				var request = new module.exports.mssqlcn2.mysql.Request(cn);

				for (var i = 0; i < params.length; i++) {
					var param = params[i];

					if ((module.exports.mssqlcn2.mysql.DateTime == param.type) && (param.value != null) && (param.value != undefined)) {
						param.value = param.value.replace(/\//gi, '-');
						request.input(param.name, module.exports.mssqlcn2.mysql.NVarChar(50), param.value);
					} else {
	...
	queryTransaction: function (isMiddleware, request, reply, sqlquery, params, fn, order, extraparam, orderb, extraparamb) {
		try {
			...
			var cn = new module.exports.mssqlcn2.mysql.Transaction(module.exports.mssqlcn.config.MSSQL_CONFIG);
			/*BEGIN TRANSACTION*/
